...
<li>ブラウザで「semi3b2025_047_login.php」にアクセスする
<li>出力形式を選択する
<li>Excelの場合、Excelファイルのダウンロード先をしてする
<li>PDFの場合、ブラウザ上に表示される
</ol>
出力するデータを変更したい場合：「data.php」内の「$data1,$data2,$orders1,$orders2」に格納されている値を変更する。
<ul>
<li>「$data1,$data2」：受注者情報や発注者情報、合計金額などのデータが格納された配列
